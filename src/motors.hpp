...
// MotorParameters GL40{14, 2.25f, 900.f * 1e-6f, 1.62f, 3.3f, 0.150f, 0.150f}; // original
MotorParameters GL40{14, 2.25f, 900.f * 1e-6f, 1.62f, 4.0f, 0.150f, 0.150f}; // higher max current
